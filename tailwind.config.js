module.exports = {
  theme: {
    ...
    fontFamily: {
      display: ['YoungSerif', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Roboto,tahoma', 'Verdana,arial', 'PingFang SC', 'Hiragino Sans GB', 'WenQuanYi Micro Hei', 'STXihei', '华文细黑', 'Microsoft Yahei', '微软雅黑', 'sans-serif'],
